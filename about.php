...
<html>
<head>
<title>Find Your Perfect Partner - Jodidaar.com | About :: Jodidaar
</title>
  ...
  <div class="container">
   ...
   <div class="about">
   	  <div class="col-md-6 about_left">
   	  	<img src="images/couple1.jpg" class="img-responsive" alt=""/>
   	  </div>
	  ...
	  <div class="about_middle-grid1">
		<div class="col-sm-6 testi_grid list-item-0">
			<blockquote class="testi_grid_blockquote">
				...
				<div><a href="#">I am very happy with Amit.Thanks a lot for Jodidaar.com…</a>
				<div class="clearfix"></div>
				</div>
			</blockquote>
		    <small class="testi-meta"><span class="user">Cristina</span></small>
		</div>
		<div class="col-sm-6 testi_grid list-item-1">
			<blockquote class="testi_grid_blockquote">
				<figure class="featured-thumbnail">
					<img src="images/amitbha.jpg" class="img-responsive" alt=""/>
				</figure>
				<div><a href="#">I also say thanks to Jodidaar.com…</a>
				<div class="clearfix"></div>
				</div>
			</blockquote>
			<small class="testi-meta1"><span class="user">Amit </span></small>
		</div>
		<div class="clearfix"> </div>
	  </div>
	  <div class="about_middle-grid2">
		<div class="col-sm-6 testi_grid list-item-0">
			<blockquote class="testi_grid_blockquote">
				...
				<div><a href="#">I am very happy with Anil.He is like a dream partner…</a>
				<div class="clearfix"></div>
				</div>
			</blockquote>
		    <small class="testi-meta"><span class="user">Kavita </span></small>
		</div>
		<div class="col-sm-6 testi_grid list-item-1">
			<blockquote class="testi_grid_blockquote">
				<figure class="featured-thumbnail">
					<img src="images/anil.jpg" class="img-responsive" alt=""/>
				</figure>
				<div><a href="#">I am vary happy by finding a soulmate like kavita.Hats off to jodidaar.com…</a>
				<div class="clearfix"></div>
				</div>
			</blockquote>
			<small class="testi-meta1"><span class="user">Anil </span></small>
		</div>
		<div class="clearfix"> </div>
	  </div>
	</div>
