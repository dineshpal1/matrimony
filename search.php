    ...
    <div class="col-sm-7 form_radios">
      <div class="select-block1">
        <select name="district">
            ...
            <option value="Wayanad">kanpur</option>
            <option value="Calicut">Agra</option>
            <option value="Malappuram">Jaipur</option> 
            <option value="Trivandrum">Bhopal</option> 
            <option value="Kannur">Delhi</option> 
            <option value="Kasargode">Varanasi</option>
        </select>
      </div>
    </div>
    <div class="clearfix"> </div>
